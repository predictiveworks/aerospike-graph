...
import de.kp.works.aerospike.gremlin.models.EdgeModel;
...
public class AeroEdge extends GraphElement implements Edge {

    private static final Logger LOGGER = LoggerFactory.getLogger(AeroEdge.class);

    private Vertex inVertex;
    private Vertex outVertex;

    public AeroEdge(AeroGraph graph, Object id) {
        this(graph, id, null, null, null, null, null, null);
    }

    public AeroEdge(AeroGraph graph, Object id, String label, Long createdAt, Long updatedAt, Map<String, Object> properties) {
    ...
    @Override
    public void copyFrom(GraphElement element) {
        super.copyFrom(element);
        if (element instanceof AeroEdge) {
            AeroEdge copy = (AeroEdge) element;
    ...
    protected void setOutVertex(AeroVertex outVertex) {
        this.outVertex = outVertex;
    }
    ...
    protected void setInVertex(AeroVertex inVertex) {
        this.inVertex = inVertex;
    }
    ...
    public void remove() {
        ...
        setDeleted(true);
        if (!isCached()) {
            AeroEdge cachedEdge = (AeroEdge) graph.findEdge(id, false);
    ...
    public <V> Iterator<Property<V>> properties(final String... propertyKeys) {
        ...
        return IteratorUtils.map(filter,
                key -> new GraphProperty<>(graph, this, key, getProperty(key)));
    }

    @Override
    public <V> Property<V> property(final String key) {
        V value = getProperty(key);
        return value != null ? new GraphProperty<>(graph, this, key, value) : Property.empty();
    }
    ...
    public <V> Property<V> property(final String key, final V value) {
        if (value != null) {
            ...
            return new GraphProperty<>(graph, this, key, value);
        } else {
            removeProperty(key);
