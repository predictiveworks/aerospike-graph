...
import de.kp.works.aerospike.gremlin.models.ElementModel;
import de.kp.works.aerospike.gremlin.mutators.Mutator;
import de.kp.works.aerospike.gremlin.mutators.Mutators;
...
public abstract class GraphElement implements Element {

    protected AeroGraph graph;
    ...
    protected GraphElement(AeroGraph graph,
                            Object id,
                            String label,
                            Long createdAt,
                            Long updatedAt,
    ...
    public void setGraph(AeroGraph graph) {
        this.graph = graph;
    }
