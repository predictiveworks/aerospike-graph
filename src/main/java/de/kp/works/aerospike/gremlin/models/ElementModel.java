...
import de.kp.works.aerospike.gremlin.mutators.PropertyIncrementer;
import de.kp.works.aerospike.gremlin.mutators.PropertyRemover;
import de.kp.works.aerospike.gremlin.mutators.PropertyWriter;
import de.kp.works.aerospike.gremlin.readers.LoadingElementReader;
...
public abstract class ElementModel extends BaseModel {
    ...
    public ElementModel(AeroGraph graph, AeroTable table) {
        super(graph, table);
    }
    ...
    public void load(Element element) {
        ...
        AeroResult result = table.get(element.id());
    ...
    public void load(List<? extends Element> elements) {
        ...
        AeroResult[] results = table.get(ids);
