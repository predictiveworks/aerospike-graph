...
public class AeroDelete extends AeroMutation {

    public AeroDelete(Object id, ElementType elementType) {
        super(id);
        this.elementType = elementType;
        mutationType = AeroMutationType.DELETE;
    }

    public void addColumn(String colName) {
        columns.add(new AeroColumn(colName));
    }
